...
int color_flag[3]; // color_flag array has 3 elements for the 3 terminals
...
void scrolling_keyboard(uint8_t c);          // scrolling function
void leftCursor(void);              // top left cursor update function
void updateCursor(int terminal);            // updates cursor positon on screen
